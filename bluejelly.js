...
//write
//--------------------------------------------------
BlueJelly.prototype.writeNumber = function(uuid, array_value) {
  return (this.scan(uuid))
  .then( () => {
    return this.connectGATT(uuid);
  })
  .then( () => {
    console.log('Execute : writeValue');
    return this.dataCharacteristic.writeValue(array_value);
  })
  .then( () => {
    this.onWrite(uuid);
  })
...
Object.defineProperty(BlueJelly, 'BLEKEYBOARD_SERVICE', {value: "19b10010-e8f2-537e-4f6c-d104768a1214", writable: true});
Object.defineProperty(BlueJelly, 'BLEKEYBOARD_CHARACTER', {value: "19b10011-e8f2-537e-4f6c-d104768a1214", writable: true});
